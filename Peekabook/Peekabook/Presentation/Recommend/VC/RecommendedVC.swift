...
class RecommendedVC: UIViewController {
    ...
    var recommendedDummy: [RecommendModel] = [
        ...
        RecommendModel(image: ImageLiterals.Sample.book1, name: "아무튼, 여름", writer: "김신회", recommendedTo: "두두", memo: "‘추천사요약’ 을 쓸 건데 나는 이 책이 상당한 지식을 얻을 수 있는 기회를 제공한다고 생각합니다. 당신에게 추천해요!")
    ]
