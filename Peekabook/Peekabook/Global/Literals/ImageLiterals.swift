...
struct ImageLiterals {
    ...
    struct TabBar {
        static let bookshelf = UIImage(named: "icn_bookshelf")
        static let bookshelfSelected = UIImage(named: "icn_bookshelf_fill")
        
        static let recommend = UIImage(named: "icn_recom")
        static let recommendSelected = UIImage(named: "icn_recom_fill")
        
        static let myPage = UIImage(named: "icn_my")
    ...
    struct Icn {
        ...
        static let cancel = UIImage(named: "icn_cancel")
        ...
        static let searchGrey = UIImage(named: "icn_search_grey")
        static let barcode = UIImage(named: "icn_barcode")
        ...
        static let profileEditSmall = UIImage(named: "icn_profileEdit")
        ...
        static let profileImageEdit = UIImage(named: "icn_edit_profileImage")
        ...
        static let appleButton = UIImage(named: "icn_login_apple")
